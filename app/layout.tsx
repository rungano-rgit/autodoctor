            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center h-16">
                ...
                <div className="hidden md:flex items-center gap-4">
                  ...
                  <Link href="/services" className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm font-semibold text-slate-100 hover:text-cyan-200 hover:bg-slate-900/40 transition duration-200"><FaTools /> Services</Link>
                  <Link href="/gallery" className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm font-semibold text-slate-100 hover:text-cyan-200 hover:bg-slate-900/40 transition duration-200"><FaImages /> Gallery</Link>
                  <Link href="/contact" className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm font-semibold text-slate-100 hover:text-cyan-200 hover:bg-slate-900/40 transition duration-200"><FaEnvelope /> Contact</Link>
                </div>
              ...
              {mobileMenuOpen && (
                <div className="md:hidden py-4 border-t border-blue-800 bg-[#0b2545]">
                  <div className="flex flex-col space-y-3 text-slate-100">
                    <Link href="/" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 hover:text-cyan-200"><FaHome /> Home</Link>
                    <Link href="/services" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 hover:text-cyan-200"><FaTools /> Services</Link>
                    <Link href="/gallery" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 hover:text-cyan-200"><FaImages /> Gallery</Link>
                    <Link href="/contact" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 hover:text-cyan-200"><FaEnvelope /> Contact</Link>
                  </div>
                </div>
              )}
            </div>
